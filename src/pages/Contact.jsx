    ...
    <div className="min-h-screen text-white">
      ...
      <div className="w-full h-[50vh] md:h-[60vh] lg:h-[70vh]">
        <iframe
          ...
          src="https://www.openstreetmap.org/export/embed.html?bbox=-80.95%2C35.05%2C-80.70%2C35.35&layer=mapnik&marker=35.2271%2C-80.8431"
          ...
          {submitted ? (
            <div className="bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-xl shadow-xl text-center">
              ...
              <p className="text-white/90 text-lg drop-shadow-xl">
                Thank you for reaching out. Luxe Affairs will be in touch soon.
              </p>
            </div>
          ) : (
            <form
